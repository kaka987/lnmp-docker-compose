...
<div id="main" class="container">
    <div id="main-index" style="display: none;">
        ...
        <?php if ($this->is('index') && $this->_currentPage != 1) {
            echo '<h4>笔记 · ' . $this->_currentPage . ' / ' . $totalpages . '</h4>';
        } ?>
        <?php while ($this->next()): ?>
            <?php
            require 'config.php';
            ...
            <article>
                <dl class="dl-horizontal">
                    <dt>
                        <a style="color:#34495e;" data-toggle="collapse" href="#<?php echo $i ?>" aria-expanded="false"
                           aria-controls="<?php $this->title() ?>">
                ...
                <ul class="dropdown-menu dropdown-menu-inverse" style="margin-bottom:15px;">
                    <?php if ($GLOBALS['tools_Pages_if'] == 'on'): ?>
                        ...
                        for ($i = 0; $i < count($pages); $i++) {
                            echo '<li><a target="_blank" href="' . $pages[$titles[$i]] . '">' . $titles[$i] . '</a></li>';
                        }
                        ?>
                    <?php else: ?>
    ...
    <div id="bottomtools" style="display: none;">
        ...
        if ($ifrun == 'on') {
            ...
            if ($GLOBALS['bottomTools_category'] == 'on') {
                echo '<span style="padding-right: 10px;">Category</span> · &nbsp;';
            ...
            if ($GLOBALS['bottomTools_tag'] == 'on') {
                echo '<span style="padding-right: 10px;">Tag</span> · &nbsp;';
            ...
            if ($GLOBALS['bottomTools_page'] == 'on') {
                echo '<span style="padding-right: 10px;">Page</span> · &nbsp;';
...
<?php if ($GLOBALS['beta_MoriGarden'] == 'on'): ?>
    <div id="thatsi" style="display:none;margin-top: 20px;">
        <center><a style="color:#34495e;" href="javascript:void(0)"><i id="getT"
                                                                       class="zmdi zmdi-chevron-down zmdi-hc-2x"></i></a>
        </center>
    </div>
<?php endif; ?>
